...
func _summon_hitbox(_attacktype : float, _attackshape : Shape2D) -> void: #function to create a hitbox based on attack
	...
	var hitbox = Hitbox.new(stats, _attacktype, _attackshape) # creates hitbox check hitbox script for details
